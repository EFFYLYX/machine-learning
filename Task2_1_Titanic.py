...
csv_data = pd.read_csv('titan.csv')
data = csv_data.to_dict('index')
# set the target name
target = 'Survived'

# rearrange the data set for later processing
(data_set, attributes) = rearrange_data(data, 'Survived')

t = id3(data_set, [0, 1, 2])
